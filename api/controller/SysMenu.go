...
// 修改菜单
// @Summary 修改菜单接口 // @Produce json
// @Description 修改菜单接口
// @Param data body entity.SysMenu true "data" // @Success 200 {object} result.Result
...
// 根据id删除菜单
// @Summary 根据id删除菜单接口 // @Produce json
// @Description 根据id删除菜单接口
// @Param data body entity.SysMenuIdDto true "data" // @Success 200 {object} result.Result
...
// @Produce json
// @Description 查询菜单列表
// @Param menuName query string false "菜单名称" // @Param menuStatus query string false "菜单状态" // @Success 200 {object} result.Result
